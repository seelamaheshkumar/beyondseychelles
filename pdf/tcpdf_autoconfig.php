...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'New_look_logo.jpg')) {
		$tcpdf_header_logo = 'New_look_logo.jpg';
	}
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'New Look Opticals');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'New Look Opticals');
}

if (!defined('PDF_HEADER_TITLE')) {
	define ('PDF_HEADER_TITLE', 'New Look Opticals');
}
