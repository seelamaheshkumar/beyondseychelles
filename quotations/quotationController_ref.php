                    ...
                    <td align="center">
                        ...
                        -->
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item editBtn" href="#"  data-id="' . $row['qid'] . '">Edit Quotation</a></li>
                                <li><a class="dropdown-item convertBtn" href="#" data-bs-toggle="modal" data-bs-target="#editModal" data-id="' . $row['qid'] . '">Convert To Job</a></li>
