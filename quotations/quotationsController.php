        ...
        if ($model->totalQuotationsRowCount() > 0) {
            ...
            foreach ($data as $row) {
                ...
                $output .= '<tr>
                    ...
                    <td align="center">
                        <div class="btn-group">
                            <button type="button" class="btn btn-bd-outline btn-sm dropdown-toggle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                Action
                            </button>
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="'.$url.'" target="_blank"><i class="bi bi-printer me-2"></i>Print</a></li>
                                <li><a class="dropdown-item editBtn" href="../editquotation/index.php?qid=' . $row['qid'] . '" data-id="' . $row['qid'] . '"><i class="bi bi-pencil me-2"></i>Edit Quotation</a></li>
                                <li><a class="dropdown-item convertBtn" href="#" data-bs-toggle="modal" data-bs-target="#editModal" data-id="' . $row['qid'] . '"><i class="bi bi-plus-square me-2"></i>Convert To Job</a></li>
                                <li><hr class="dropdown-divider"></li>
                                <li><a class="dropdown-item text-danger delBtn" href="#" data-id="' . $row['qid'] . '"><i class="bi bi-trash me-2"></i>Delete Quotation</a></li>
                            </ul>
                        </div>
                    </td>
                </tr>';
